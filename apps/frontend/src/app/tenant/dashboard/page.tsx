...
import { ShieldCheck, ShieldAlert, FileText, ArrowRight, Home } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#E8E8E8] shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2">
          <div className="text-xs text-[#E03C3D] font-bold uppercase tracking-wider">Dashboard Khách Hàng</div>
        ...
        <div className="p-4 rounded-2xl bg-[#F9F9F9] border border-[#E8E8E8] shrink-0 space-y-2">
          ...
          {mounted && user?.isActive ? (
            ...
            <div className="space-y-2">
              <div className="text-xs font-bold text-[#D97706] flex items-center gap-1.5 bg-[#FFFBEB] border border-[#FEF3C7] px-3 py-1.5 rounded-xl animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link
          ...
          className="group p-6 rounded-2xl bg-white border border-[#E8E8E8] hover:border-[#E03C3D]/40 shadow-sm transition-all space-y-4"
        >
          <div className="w-10 h-10 rounded-xl bg-[#FFF5F5] border border-[#E03C3D]/10 text-[#E03C3D] flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="text-xs font-bold text-[#E03C3D] flex items-center gap-1 pt-2">
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-[#5A5A5A] mt-1">Tìm kiếm không giới hạn & nhận gợi ý từ AI Broker Agent</p>
          </div>
          <div className="text-xs font-bold text-[#E03C3D] flex items-center gap-1 pt-2">
