                  ...
                  {role === 'owner' && r.status === 'Accepted' && (
                    checkHasContract(r) ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#E03C3D] hover:bg-[#C92F30] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg text-xs font-bold transition-colors"
                      >
                        {actionLoading ? 'Đang tạo...' : 'Tạo Hợp Đồng Nháp'}
                      </button>
                    )
                  )}
                </div>
              ...
              {role === 'owner' && selectedRequest.status === 'Accepted' && (
                checkHasContract(selectedRequest) ? (
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#E03C3D] hover:bg-[#C92F30] disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl text-xs font-bold transition-colors"
                  >
                    {actionLoading ? 'Đang tạo...' : 'Tạo Hợp Đồng Nháp'}
                  </button>
                )
